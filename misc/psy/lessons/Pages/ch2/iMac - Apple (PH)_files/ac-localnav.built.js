...
}},{"./className":6,"@marcom/ac-polyfills/Element/prototype.classList":75}],15:[function(c,d,b){var g=c("@marcom/ac-prefixer/getStyleValue");
...
d.exports.original=a},{"@marcom/ac-function/memoize":18,"@marcom/ac-prefixer/getStyleProperty":20,"@marcom/ac-prefixer/getStyleValue":21}],16:[function(b,c,a){c.exports={getWindow:function(){return window
},getDocument:function(){return document},getNavigator:function(){return navigator
}}},{}],17:[function(c,d,b){c("@marcom/ac-polyfills/matchMedia");var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var i=g.getWindow();var h=i.matchMedia("only all");
return !!(h&&h.matches)}d.exports=f(a);d.exports.original=a},{"./helpers/globals":16,"@marcom/ac-function/once":19,"@marcom/ac-polyfills/matchMedia":81}],18:[function(c,d,b){var a=function(){var h="";
...
}},{}],19:[function(b,c,a){c.exports=function d(g){var f;return function(){if(typeof f==="undefined"){f=g.apply(this,arguments)
}return f}}},{}],20:[function(f,d,h){var a=f("./shared/stylePropertyCache");var i=f("./shared/getStyleTestElement");
...
}return c(p,n[m])}}return c(p,false)}},{"./shared/getStyleTestElement":22,"./shared/prefixHelper":23,"./shared/stylePropertyCache":24,"./utils/toCSS":26,"./utils/toDOM":27}],21:[function(d,b,h){var f=d("./getStyleProperty");
...
}},{"./getStyleProperty":20,"./shared/prefixHelper":23,"./shared/stylePropertyCache":24,"./shared/styleValueAvailable":25}],22:[function(c,d,b){var f;
d.exports=function a(){if(!f){f=document.createElement("_")}else{f.style.cssText="";
f.removeAttribute("style")}return f};d.exports.resetElement=function(){f=null}},{}],23:[function(b,d,a){var i=["-webkit-","-moz-","-ms-"];
...
this.dom=[this.dom[j]];this.evt=[this.evt[j]]}};d.exports=new c()},{}],24:[function(b,c,a){c.exports={}
},{}],25:[function(c,b,d){var a=c("./stylePropertyCache");var f=c("./getStyleTestElement");
...
}},{"./getStyleTestElement":22,"./stylePropertyCache":24}],26:[function(c,d,b){var f=/^(webkit|moz|ms)/gi;
...
}},{}],27:[function(b,c,a){var f=/-([a-z])/g;c.exports=function d(h){var g;if(h.toLowerCase()==="float"){return"cssFloat"
}h=h.replace(f,function(j,i){return i.toUpperCase()});if(h.substr(0,2)==="Ms"){h="ms"+h.substring(2)
}return h}},{}],28:[function(c,d,b){var g=c("./helpers/globals");var f=c("@marcom/ac-function/once");
function a(){var h=g.getDocument();return !!h.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":16,"@marcom/ac-function/once":19}],29:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":16,"@marcom/ac-function/once":19}],30:[function(b,d,a){var g=b("@marcom/ac-classlist/add");
...
}return f({},h,g)}},{"./extend":62}],62:[function(b,c,a){c.exports=b(31)},{"@marcom/ac-polyfills/Array/prototype.forEach":70}],63:[function(b,a,d){b("@marcom/ac-polyfills/Function/prototype.bind");
b("@marcom/ac-polyfills/Object/keys");b("@marcom/ac-polyfills/Object/create");var k=b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
var h=b("@marcom/ac-dom-events/utils/addEventListener");var g=b("@marcom/ac-feature/mediaQueriesAvailable");
var c="viewport-emitter";var i="::before";function j(l){k.call(this);this._initializeElement(l);
if(g()){this._update=this._update.bind(this);h(window,"resize",this._update);h(window,"orientationchange",this._update)
}this._update()}var f=j.prototype=Object.create(k.prototype);f.viewport=false;f._initializeElement=function(m){var l;
m=m||c;l=document.getElementById(m);if(!l){l=document.createElement("div");l.id=m;
l=document.body.appendChild(l)}this._el=l};f._getElementContent=function(){var l;
if("currentStyle" in this._el){l=this._el.currentStyle["x-content"]}else{this._invalidateStyles();
l=window.getComputedStyle(this._el,i).content}return l.replace(/["']/g,"")};f._update=function(){var l=this.viewport;
var m;var n;this.viewport=this._getElementContent();this.viewport=this.viewport.split(":").pop();
if(l&&this.viewport!==l){n={from:l,to:this.viewport};this.trigger("change",n);this.trigger("from:"+l,n);
this.trigger("to:"+this.viewport,n)}};f._invalidateStyles=function(){document.documentElement.clientWidth;
this._el.innerHTML=(this._el.innerHTML===" ")?" ":" ";document.documentElement.clientWidth
};a.exports=j},{"@marcom/ac-dom-events/utils/addEventListener":34,"@marcom/ac-event-emitter-micro":59,"@marcom/ac-feature/mediaQueriesAvailable":17,"@marcom/ac-polyfills/Function/prototype.bind":76,"@marcom/ac-polyfills/Object/create":77,"@marcom/ac-polyfills/Object/keys":78}],64:[function(m,a,u){m("@marcom/ac-polyfills/Function/prototype.bind");
...
this.stuck=false;this.trigger("unstuck")}}};b.exports=j},{"@marcom/ac-classlist/add":5,"@marcom/ac-classlist/remove":13,"@marcom/ac-dom-events/utils/addEventListener":34,"@marcom/ac-dom-metrics/getScrollY":35,"@marcom/ac-dom-nodes/insertBefore":42,"@marcom/ac-event-emitter-micro":59,"@marcom/ac-feature/cssPropertyAvailable":15,"@marcom/ac-polyfills/Object/create":77}],68:[function(b,c,a){if(!Array.isArray){Array.isArray=function(d){return Object.prototype.toString.call(d)==="[object Array]"
