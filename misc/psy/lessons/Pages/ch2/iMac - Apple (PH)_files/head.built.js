...
};c.exports=f},{"./data":4,"ac-polyfills/Array/prototype.filter":23,"ac-polyfills/Array/prototype.some":26}],3:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":6,"ac-polyfills/Array/prototype.slice":25,"ac-polyfills/Element/prototype.classList":27}],6:[function(b,c,a){var d=b("./contains");
...
}}},{"./contains":7,"./getTokenRegExp":8}],10:[function(d,f,c){d("ac-polyfills/Array/prototype.slice");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":9,"ac-polyfills/Array/prototype.slice":25,"ac-polyfills/Element/prototype.classList":27}],11:[function(b,c,a){c.exports={getWindow:function(){return window
...
}return f}}},{}],13:[function(c,d,b){var g=c("./helpers/globals");var f=c("ac-function/once");
function a(){var h=g.getDocument();return !!h.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":11,"ac-function/once":12}],14:[function(c,d,b){var g=c("./helpers/globals");
var f=c("ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":11,"ac-function/once":12}],15:[function(b,d,a){var g=b("ac-classlist/add");
...
}}};d.exports=c},{"ac-classlist/add":5,"ac-classlist/remove":10,"ac-object/extend":22}],16:[function(d,h,c){var i=d("ac-browser");
...
},{"ac-browser":18,"ac-feature/svgAvailable":13,"ac-feature/touchAvailable":14}],17:[function(b,d,a){b("ac-polyfills");
var c=b("./FeatureDetect");var f=b("./defaultTests");d.exports=new c(document.documentElement,f);
d.exports.FeatureDetect=c},{"./FeatureDetect":15,"./defaultTests":16,"ac-polyfills":"ac-polyfills"}],18:[function(b,c,a){arguments[4][1][0].apply(a,arguments)
},{"./ac-browser/BrowserData":19,"./ac-browser/IE":20,dup:1}],19:[function(b,c,a){var d=b("./data");
...
h.os=g.__getOS(d.os);h.osVersion=g.__getOSVersion(d.versionString,h.os);return h
};c.exports=f},{"./data":21}],20:[function(b,c,a){arguments[4][3][0].apply(a,arguments)
},{dup:3}],21:[function(b,c,a){c.exports={browser:[{string:window.navigator.userAgent,subString:"Chrome",identity:"Chrome"},{string:window.navigator.userAgent,subString:/silk/i,identity:"Silk"},{string:window.navigator.userAgent,subString:"OmniWeb",versionSearch:"OmniWeb/",identity:"OmniWeb"},{string:window.navigator.userAgent,subString:/mobile\/[^\s]*\ssafari\//i,identity:"Safari Mobile",versionSearch:"Version"},{string:window.navigator.vendor,subString:"Apple",identity:"Safari",versionSearch:"Version"},{prop:window.opera,identity:"Opera",versionSearch:"Version"},{string:window.navigator.vendor,subString:"iCab",identity:"iCab"},{string:window.navigator.vendor,subString:"KDE",identity:"Konqueror"},{string:window.navigator.userAgent,subString:"Firefox",identity:"Firefox"},{string:window.navigator.vendor,subString:"Camino",identity:"Camino"},{string:window.navigator.userAgent,subString:"Netscape",identity:"Netscape"},{string:window.navigator.userAgent,subString:"MSIE",identity:"IE",versionSearch:"MSIE"},{string:window.navigator.userAgent,subString:"Trident",identity:"IE",versionSearch:"rv"},{string:window.navigator.userAgent,subString:"Gecko",identity:"Mozilla",versionSearch:"rv"},{string:window.navigator.userAgent,subString:"Mozilla",identity:"Netscape",versionSearch:"Mozilla"}],os:[{string:window.navigator.platform,subString:"Win",identity:"Windows",versionSearch:"Windows NT"},{string:window.navigator.platform,subString:"Mac",identity:"OS X"},{string:window.navigator.userAgent,subString:"iPhone",identity:"iOS",versionSearch:"iPhone OS"},{string:window.navigator.userAgent,subString:"iPad",identity:"iOS",versionSearch:"CPU OS"},{string:window.navigator.userAgent,subString:/android/i,identity:"Android"},{string:window.navigator.platform,subString:"Linux",identity:"Linux"}],versionString:window.navigator.userAgent||window.navigator.appVersion||undefined}
},{}],22:[function(c,d,b){c("ac-polyfills/Array/prototype.forEach");var a=Object.prototype.hasOwnProperty;
...
}}}});return g}},{"ac-polyfills/Array/prototype.forEach":24}],23:[function(b,c,a){if(!Array.prototype.filter){Array.prototype.filter=function d(l,k){var j=Object(this);
var f=j.length>>>0;var h;var g=[];if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}for(h=0;h<f;h+=1){if(h in j&&l.call(k,j[h],h,j)){g.push(j[h])}}return g}}},{}],24:[function(b,c,a){if(!Array.prototype.forEach){Array.prototype.forEach=function d(k,j){var h=Object(this);
var f;var g;if(typeof k!=="function"){throw new TypeError("No function object passed to forEach.")
}for(f=0;f<this.length;f+=1){g=h[f];k.call(j,g,f,h)}}}},{}],25:[function(b,c,a){(function(){var d=Array.prototype.slice;
try{d.call(document.documentElement)}catch(f){Array.prototype.slice=function(n,j){j=(typeof j!=="undefined")?j:this.length;
if(Object.prototype.toString.call(this)==="[object Array]"){return d.call(this,n,j)
}var l,h=[],k,g=this.length;var o=n||0;o=(o>=0)?o:g+o;var m=(j)?j:g;if(j<0){m=g+j
}k=m-o;if(k>0){h=new Array(k);if(this.charAt){for(l=0;l<k;l++){h[l]=this.charAt(o+l)
}}else{for(l=0;l<k;l++){h[l]=this[o+l]}}}return h}}}())},{}],26:[function(b,c,a){if(!Array.prototype.some){Array.prototype.some=function d(k,j){var g=Object(this);
var f=g.length>>>0;var h;if(typeof k!=="function"){throw new TypeError(k+" is not a function")
}for(h=0;h<f;h+=1){if(h in g&&k.call(j,g[h],h,g)===true){return true}}return false
}}},{}],27:[function(b,c,a){
/*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js*/
...
h.call(this,l)}}};g("add");g("remove")}f.classList.toggle("c3",false);if(f.classList.contains("c3")){var d=DOMTokenList.prototype.toggle;
DOMTokenList.prototype.toggle=function(h,i){if(1 in arguments&&!this.contains(h)===!i){return i
}else{return d.call(this,h)}}}f=null}())}}},{}],28:[function(b,c,a){var f=b("ac-headjs");
var g=b("ac-browser");var d=(function(){return{initialize:function(){f.addTests({ios:function(){return(g.os==="iOS")
}});f.htmlClass();return this}}}());c.exports=d.initialize()},{"ac-browser":1,"ac-headjs":17}]},{},[28]);